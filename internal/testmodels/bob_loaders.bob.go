...
type preloaders struct {
	OrganizationPlanBuyer organizationPlanBuyerPreloader
	OrganizationPlan      organizationPlanPreloader
	Organization          organizationPreloader
}

func getPreloaders() preloaders {
	return preloaders{
		OrganizationPlanBuyer: buildOrganizationPlanBuyerPreloader(),
		OrganizationPlan:      buildOrganizationPlanPreloader(),
...
type thenLoaders[Q orm.Loadable] struct {
	OrganizationPlanBuyer organizationPlanBuyerThenLoader[Q]
	OrganizationPlan      organizationPlanThenLoader[Q]
	Organization          organizationThenLoader[Q]
}

func getThenLoaders[Q orm.Loadable]() thenLoaders[Q] {
	return thenLoaders[Q]{
		OrganizationPlanBuyer: buildOrganizationPlanBuyerThenLoader[Q](),
		OrganizationPlan:      buildOrganizationPlanThenLoader[Q](),
